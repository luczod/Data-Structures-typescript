...
import Dictionary from '../dictionary/dictionary-class';
...
describe('Dictionary', () => {
  ...
  it('sets undefined and null keys and values', () => {
    ...
    expect(dict.set('undefined', undefined)).toEqual(false);
    expect(dict.get('undefined')).toEqual(undefined);

    expect(dict.set('undefined', 1)).toEqual(true);
    expect(dict.get('undefined')).toEqual(1);

    expect(dict.set('null', null)).toEqual(false);
    expect(dict.get('null')).toEqual(undefined);

    expect(dict.set('null', 1)).toEqual(true);
    ...
    expect(dict.set(undefined, 1)).toEqual(false);
    expect(dict.get(undefined)).toEqual(undefined);

    expect(dict.set(null, null)).toEqual(false);
    expect(dict.get(null)).toEqual(undefined);

    expect(dict.set(null, 1)).toEqual(false);
    expect(dict.get(null)).toEqual(undefined);
  });
  ...
  it('sets values with string key', () => {
    ...
    for (let i = min; i <= max; i++) {
      expect(dict.set(`${i}`, i)).toEqual(true);
    }
  ...
  it('sets values with object', () => {
    ...
    for (let i = min; i < max; i++) {
      expect(dict.set(myObjList[i], myObjList[i])).toEqual(true);
    }
    expect(dict.size()).toEqual(size);
  ...
  it('removes elements', () => {
    ...
    for (let i = min; i <= max; i++) {
      expect(dictionary.remove(i)).toEqual(true);
    }
