...
import { SortedLinkedList } from '../list-sorted/linked-sorted-class';

describe('Sorted-List-single', () => {
  ...
  it('inserts elements first position empty list', () => {
    ...
    expect(list.insert(element)).toEqual(true);
    verifyList();
  });

  it('inserts elements first position not empty list', () => {
    max = 2;
    expect(list.insert(max)).toEqual(true);

    expect(list.insert(min)).toEqual(true);
  ...
  it('inserts elements in the middle of list', () => {
    ...
    expect(list.insert(1)).toEqual(true);
    expect(list.insert(2)).toEqual(true);
    verifyList();
  });
  ...
  it('returns toString primitive types: string', () => {
    const ds = new SortedLinkedList<string>();
    ds.push('elem1');
  ...
  it('returns toString objects', () => {
    const ds = new SortedLinkedList<MyObj>();
